...
public class DlgCadAluno extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        chkEmagrecimento.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/images/square-small.png"))); // NOI18N
        chkEmagrecimento.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/images/check-circle.png"))); // NOI18N

        chkCondicionamento.setText("Condicionamento");
        chkCondicionamento.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/images/square-small.png"))); // NOI18N
        chkCondicionamento.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/images/check-circle.png"))); // NOI18N

        chkHipertrofia.setText("Hipertrofia");
        chkHipertrofia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/images/square-small.png"))); // NOI18N
        chkHipertrofia.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/images/check-circle.png"))); // NOI18N

        chkReabilitacao.setText("Reabilitacao");
        chkReabilitacao.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/images/square-small.png"))); // NOI18N
        chkReabilitacao.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/images/check-circle.png"))); // NOI18N
        ...
        btSalvar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/images/disk (1).png"))); // NOI18N
